...
#
# Script generated by Vivado on Sun Oct 27 14:45:40 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_i2s_module.sh
...
#
# Usage        : tb_i2s_module.sh
#                tb_i2s_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_i2s_module.sh [-reset_run]
#                tb_i2s_module.sh [-reset_log]
#                tb_i2s_module.sh [-help]
#
...
#                script (type 'tb_i2s_module.sh -help' for more information).
#
...
# script info
echo -e "tb_i2s_module.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_i2s_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+"I:/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+"I:/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+"I:/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../../../ES/ ZG/ 626/ Hardware/ software/ co-design/project_i2s/bram/bram.srcs/sources_1/new/i2s_master_rx.v" \
  "../../../../../../ES/ ZG/ 626/ Hardware/ software/ co-design/project_i2s/bram/bram.srcs/sources_1/new/i2s_master_tx.v" \
  "../../../../../../ES/ ZG/ 626/ Hardware/ software/ co-design/project_i2s/bram/bram.srcs/sources_1/new/i2s_module.v" \
  "../../../../../../ES/ ZG/ 626/ Hardware/ software/ co-design/project_i2s/bram/bram.srcs/sim_1/new/tb_i2s_module.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_i2s_module xil_defaultlib.glbl -o tb_i2s_module_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_i2s_module_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tb_i2s_module_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_i2s_module_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_i2s_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_i2s_module.sh [-help]\n\
Usage: tb_i2s_module.sh [-step]\n\
Usage: tb_i2s_module.sh [-lib_map_path]\n\
Usage: tb_i2s_module.sh [-reset_run]\n\
Usage: tb_i2s_module.sh [-reset_log]\n\
Usage: tb_i2s_module.sh [-keep_index]\n\
Usage: tb_i2s_module.sh [-noclean_files]\n\n\
