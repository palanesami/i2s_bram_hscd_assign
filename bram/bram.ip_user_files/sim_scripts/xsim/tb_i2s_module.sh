...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xilinx_vip -L xpm -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_i2s_module xil_defaultlib.tb_i2s_module xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_i2s_module -key {Behavioral:sim_1:Functional:tb_i2s_module} -tclbatch cmd.tcl -protoinst "protoinst_files/design_bram.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="I:/mtech/vivado/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_i2s_module.wdb xsim.dir libdpi.so)
