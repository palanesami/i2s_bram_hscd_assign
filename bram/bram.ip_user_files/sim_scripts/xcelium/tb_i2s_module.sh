...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+":/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+":/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/ec67/hdl" +incdir+"../../../bram.gen/sources_1/bd/design_bram/ipshared/b28c/hdl" +incdir+":/mtech/vivado/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_i2s_module xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_i2s_module -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_i2s_module_sc.so .tmp_log xcelium_lib waves.shm c.obj)
